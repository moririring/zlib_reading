; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.22816.0 
	...
	TITLE	C:\Users\BinMatsui\Downloads\zlib128\zlib-1.2.8\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG86419 DB	'incorrect header check', 00H
	ORG $+1
$SG86421 DB	'unknown compression method', 00H
	ORG $+1
$SG86425 DB	'invalid window size', 00H
$SG86429 DB	'unknown compression method', 00H
	ORG $+1
$SG86431 DB	'unknown header flags set', 00H
	ORG $+3
$SG86478 DB	'header crc mismatch', 00H
$SG86495 DB	'invalid block type', 00H
	ORG $+1
$SG86499 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG86511 DB	'too many length or distance symbols', 00H
$SG86515 DB	'invalid code lengths set', 00H
	ORG $+3
$SG86525 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86531 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86534 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG86536 DB	'invalid literal/lengths set', 00H
$SG86538 DB	'invalid distances set', 00H
	ORG $+2
$SG86552 DB	'invalid literal/length code', 00H
$SG86563 DB	'invalid distance code', 00H
	ORG $+2
$SG86573 DB	'invalid distance too far back', 00H
	ORG $+2
$SG86586 DB	'incorrect data check', 00H
	ORG $+3
$SG86591 DB	'incorrect length check', 00H
	ORG $+1
$SG85865 DB	'1.2.8', 00H
_DATA	ENDS
PUBLIC	_inflate@8
...
; File c:\users\binmatsui\downloads\zlib128\zlib-1.2.8\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 189  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG85865[edx]
	cmp	eax, ecx
...
; 662  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86419
...
; 667  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86421
...
; 676  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86425
...
; 691  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86429
...
; 696  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86431
...
; 800  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86478
...
; 859  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86495
...
; 868  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86499
...
; 907  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86511
...
; 929  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86515
...
; 952  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86525
...
; 975  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86531
...
; 989  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86534
...
; 1003 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86536
...
; 1012 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86538
...
; 1064 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86552
...
; 1100 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86563
...
; 1189 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86586
...
; 1202 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86591
