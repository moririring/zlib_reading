; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.22816.0 
	...
	TITLE	C:\Users\BinMatsui\Downloads\zlib128\zlib-1.2.8\infback.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG86203 DB	'invalid block type', 00H
	ORG $+1
$SG86208 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG86220 DB	'too many length or distance symbols', 00H
$SG86224 DB	'invalid code lengths set', 00H
	ORG $+3
$SG86235 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86243 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86246 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG86248 DB	'invalid literal/lengths set', 00H
$SG86250 DB	'invalid distances set', 00H
	ORG $+2
$SG86266 DB	'invalid literal/length code', 00H
$SG86278 DB	'invalid distance code', 00H
	ORG $+2
$SG86283 DB	'invalid distance too far back', 00H
	ORG $+2
$SG85817 DB	'1.2.8', 00H
_DATA	ENDS
...
; File c:\users\binmatsui\downloads\zlib128\zlib-1.2.8\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 37   :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG85817[edx]
	cmp	eax, ecx
...
; 320  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86203
...
; 331  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86208
...
; 369  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86220
...
; 391  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86224
...
; 414  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86235
...
; 437  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86243
...
; 465  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86248
...
; 474  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86250
...
; 532  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86266
...
; 579  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86283
