; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.22816.0 
	...
	TITLE	C:\Users\BinMatsui\Downloads\zlib128\zlib-1.2.8\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG88835 DB	'rb', 00H
	ORG $+5
$SG88896 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG88899 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG88900 DB	'file %s read, %u bytes', 0aH, 00H
$SG88904 DB	'1.2.8', 00H
	ORG $+2
$SG88905 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG88906 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG88907 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG88908 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG88909 DB	'1.2.8', 00H
	ORG $+2
$SG88910 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG88911 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG88912 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG88913 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG88916 DB	'compare ok', 0aH, 00H
_DATA	ENDS
...
; File c:\users\binmatsui\downloads\zlib128\zlib-1.2.8\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\program files (x86)\windows kits\10\include\10.0.10056.0\ucrt\stdio.h
;	COMDAT _printf
_TEXT	SEGMENT
__Result$ = -8						; size = 4
__ArgList$ = -4						; size = 4
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\program files (x86)\windows kits\10\include\10.0.10056.0\ucrt\corecrt_stdio_config.h
