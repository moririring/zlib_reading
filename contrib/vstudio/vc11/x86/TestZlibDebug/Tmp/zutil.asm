; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.22816.0 
	...
	TITLE	C:\Users\BinMatsui\Downloads\zlib128\zlib-1.2.8\zutil.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG89323 DB	'need dictionary', 00H
$SG89324 DB	'stream end', 00H
	ORG $+1
$SG89326 DB	'file error', 00H
	ORG $+1
$SG89327 DB	'stream error', 00H
	ORG $+3
$SG89328 DB	'data error', 00H
	ORG $+1
$SG89329 DB	'insufficient memory', 00H
$SG89330 DB	'buffer error', 00H
	ORG $+3
$SG89331 DB	'incompatible version', 00H
	ORG $+3
$SG89334 DB	'1.2.8', 00H
_DATA	ENDS
...
; File c:\users\binmatsui\downloads\zlib128\zlib-1.2.8\zutil.c
_TEXT	SEGMENT
_opaque$ = 8						; size = 4
_ptr$ = 12						; size = 4
_zcfree	PROC
